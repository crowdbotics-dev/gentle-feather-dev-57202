"""
Django settings for gentle_feather_dev_57202 project.
...
ROOT_URLCONF = 'gentle_feather_dev_57202.urls'
...
WSGI_APPLICATION = 'gentle_feather_dev_57202.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_feather_dev_57202 API",
    "DESCRIPTION": "API documentation for gentle_feather_dev_57202 App",
    "VERSION": "v1",
}
